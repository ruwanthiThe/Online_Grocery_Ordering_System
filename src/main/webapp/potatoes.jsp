...
<section class="containt-page">
            <div class="details_view">
                <h1 class="h1_pagedataview">Potatoes</h1>
                <p class="page_p">Potatoes are rich in vitamins, minerals and antioxidants, which make them very healthy. Studies have linked potatoes and their nutrients to a variety of impressive health benefits, including improved blood sugar control, reduced heart disease risk and higher immunity. </p>
                <p class="page_p">They may also improve digestive health and combat signs of aging. Potatoes are also quite filling, which means they may help you lose weight by curbing hunger pains and cravings.</p>
                <p class="page_p">All in all, potatoes are a great addition to your diet in moderation. </p>
            </div>
            <div>
